...
//# OPTIMISATION 0 : WITH BUCKETING - RESULT : BOTH SIDE SHUFFLE FREE JOIN
...
//# OPTIMISATION I : 1 BUCKETED TABLE WITH ONE UNBUCJETED TABLE : 
...
// OPTIMISATION 2 : AGGREGATION FOLLOWED BY A JOIN
